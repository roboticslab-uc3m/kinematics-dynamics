...
#ifndef __TEO_COLLISION_AVOIDANCE_HPP__
#define __TEO_COLLISION_AVOIDANCE_HPP__
...
#define DEFAULT_TEO_COLLISION_AVOIDANCE_MS 20.0  // [ms]
 ...
 */
class TeoCollisionAvoidance : public yarp::os::RFModule {

    public:

// -------- RFModule declarations. Implementation in TeoCollisionAvoidance.cpp --------
    ...
    protected:
        ...
        //
        TeoCollisionAvoidanceRateThread teoCollisionAvoidanceRateThread;
...
#endif  // __TEO_COLLISION_AVOIDANCE_HPP__
