...
#include <yarp/math/Math.h> // operators
...
int main(int argc, char *argv[])
{
    ...
    double height = 0.1;
    double tilt = 90.0;  // 90 deg from vertical = horizontal std kinect looking position.
    double pan = 10.0;  // deg, from front

    std::printf("Lets say a 3D sensor grabbed a point at sensor coordinates %f, %f, %f.\n\n", x_k, y_k, z_k);
    ...
    std::printf("In origin coordinates this would be: %f, %f, %f.\n", x_0, y_0, z_0);
