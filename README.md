...
Bartek Łukawski, Mercedes Rebollo, Ángel Gilabert, Juan G. Victores, Carlos Balaguer, and Alberto Jardón. YARP Cartesian controller layers over ROS 2 for teleoperation and web applications. In *XLVI Jornadas de Automática*, pages xxx-xxx. Universidade da Coruña, 2025.
...
@inproceedings{lukawski2025jjaa,
    ...
    pages     = {xxx--xxx},
    publisher = {Universidade da Coruña},
    doi       = {10.17979/spudc.xxxxxxxxxxxxx.xxx},
}
```
