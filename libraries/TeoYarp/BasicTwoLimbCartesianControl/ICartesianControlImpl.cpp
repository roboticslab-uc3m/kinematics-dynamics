...
bool teo::BasicTwoLimbCartesianControl::inv(const std::vector<double> &xd, std::vector<double> &q)
{
    std::vector<double> currentQ(numRobotJoints);
    if ( ! iEncoders->getEncoders( currentQ.data() ) )
    {
...
bool teo::BasicTwoLimbCartesianControl::movj(const std::vector<double> &xd)
{
...
bool teo::BasicTwoLimbCartesianControl::movl(const std::vector<double> &xd)
{
...
bool teo::BasicTwoLimbCartesianControl::movv(const std::vector<double> &xdotd)
{
...
bool teo::BasicTwoLimbCartesianControl::gcmp()
{
    //-- Set torque mode and set state which makes rate thread implement control.
...
bool teo::BasicTwoLimbCartesianControl::forc(const std::vector<double> &td)
{
