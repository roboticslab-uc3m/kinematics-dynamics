...
bool teo::KdlController::getMatrixFromProperties(Searchable &options, ConstString &tag, yarp::sig::Matrix &H) {
...
bool teo::KdlController::fwdKin(const yarp::sig::Vector &inUnits, yarp::sig::Vector &x, yarp::sig::Vector &o) {
