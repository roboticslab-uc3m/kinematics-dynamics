...
bool KdlSolver_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="quiet")
    {
        if (m_quiet==true) paramValue = "true";
        else paramValue = "false";
        return true;
    }
    if (paramName =="kinematics")
    {
        paramValue = m_kinematics;
        return true;
    }
    ...
    if (paramName =="epsPos")
    {
        paramValue = std::to_string(m_epsPos);
        return true;
    }
    if (paramName =="maxIterPos")
    {
        paramValue = std::to_string(m_maxIterPos);
        return true;
    }
    if (paramName =="epsVel")
    {
        paramValue = std::to_string(m_epsVel);
        return true;
    }
    if (paramName =="maxIterVel")
    {
        paramValue = std::to_string(m_maxIterVel);
        return true;
    }
    if (paramName =="lambda")
    {
        paramValue = std::to_string(m_lambda);
        return true;
    }
    if (paramName =="weightsLMA")
    {
        return false;
    }
    if (paramName =="weightsJS")
    {
        return false;
    }
    if (paramName =="weightsTS")
    {
        return false;
    }
...
std::string KdlSolver_ParamsParser::getConfiguration() const
{
