...
{
    return KinRepresentation::encodePose(vin, vin, coord, orient, KinRepresentation::DEGREES);
}
...
{
    return KinRepresentation::decodePose(vout, vout, coord, orient, KinRepresentation::DEGREES);
}
