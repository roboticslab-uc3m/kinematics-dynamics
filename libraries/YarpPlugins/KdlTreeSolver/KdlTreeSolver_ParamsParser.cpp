...
bool KdlTreeSolver_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    ...
    if (paramName =="vTranslMax")
    {
        paramValue = std::to_string(m_vTranslMax);
        return true;
    }
    if (paramName =="vRotMax")
    {
        paramValue = std::to_string(m_vRotMax);
        return true;
    }
    if (paramName =="lambda")
    {
...
std::string KdlTreeSolver_ParamsParser::getConfiguration() const
{
