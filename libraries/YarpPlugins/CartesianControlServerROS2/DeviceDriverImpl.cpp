...
bool CartesianControlServerROS2::open(yarp::os::Searchable & config)
{
    ...
    descriptor_streaming_cmd.additional_constraints = "Only 'twist', 'pose', 'wrench' or 'none' are allowed.";
    descriptor_streaming_cmd.set__type(rcl_interfaces::msg::ParameterType::PARAMETER_STRING);

    m_node->declare_parameter("preset_streaming_cmd", "none", descriptor_streaming_cmd); //null default value
